          ...
          <Reveal>
            ...
            >
              ...
              */}
              ...
              <span className="md:justify-self-start md:text-left">방식을 바꿉니다</span>
            </h1>
          </Reveal>
...
function ProcessSteps() {
  return (
    <section className="relative overflow-hidden pt-0 pb-16 text-white md:pt-0 md:pb-40" id="process-steps">
      <Container>
        <PillHeading
          eyebrow="Approach"
        ...
        <div className="relative mx-auto mt-10 grid max-w-6xl gap-8 md:grid-cols-2 lg:gap-6 lg:grid-cols-4">
...
function PartnersSection() {
  return (
    <section className="bg-ink-950 pt-4 pb-8 text-white md:pt-8 md:pb-10" id="partners">
